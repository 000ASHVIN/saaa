...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table" mc:repeatable=""
       style="max-width: 800px" width="600">
    <tbody>
    <tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
       style="background: no-repeat center top / 100% 100%; max-width: 800px" width="600">
    <tbody>
    <tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td class="content space_class" height="10" style="font-size: 1px; line-height: 1px" width="600"> </td>
    </tr>
    </tbody>
</table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Dear {{ ucwords($user->first_name) }} {{ ucwords($user->last_name) }}</p>
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Thank you for choosing SA Accounting Academy.</p>
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif"><strong>Your OTP (One-time Pin) is {{ $otp }}</strong></p>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td class="content height40 space_class" height="10" style="font-size: 1px; line-height: 1px" width="600"> </td>
    </tr>
    </tbody>
</table>
