...
<p style="color: #9e9e9e; font-size: 13px;"><span color="#000000" style="color: #000000;"><span
                style="font-size: 14px;">This email is to confirm that we have successfully charged your credit card</span></span></p>
<p style="color: #9e9e9e; font-size: 13px;"></p>
...
<ul>
<li><span color="#000000" style="color: #000000;"><span style="font-size: 14px;">That you can add multiple credit cards to your account? You have the ability to set one of your credit cards as your primary cards, This will ensure that all the charges will be deducted from your primary card.</span></span><span
            color="#000000" style="color: #000000;"><span style="font-size: 14px;"></span></span></li>
<li><span color="#000000" style="color: #000000;"><span style="font-size: 14px;">You can now use your debit card as a credit card, currently in South Africa all major banks has implemented this functionality for users to use their debit cards as a credit card.</span></span><span
            color="#000000" style="color: #000000;"><span style="font-size: 14px;"></span></span></li>
<li><span color="#000000" style="color: #000000;"><span style="font-size: 14px;">To link your debit card to your account, simply follow the same steps as you would have followed to save your credit card. If your debit card has been enrolled for 3Dsecure you will receive an SMS with a top that you need to confirm.</span></span></li>
</ul>
<p><span color="#000000" style="color: #000000;"><span style="font-size: 14px;"></span></span></p>
<p><span color="#000000" style="color: #000000;"><span style="font-size: 14px;"></span></span><span color="#000000"
                                                                                                    style="color: #000000;"><span
                style="font-size: 14px;">For any queries, please feel free to contact us on&nbsp;010 593 0466 or kindly send us an email to&nbsp;<a
