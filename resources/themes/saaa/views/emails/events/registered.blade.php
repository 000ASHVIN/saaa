        ...
        <td border="0" align="center">
            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Your event registration has been completed.</td>
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br><br>
                        Thank you for registering to attend the event: <strong>{{ $data['event_name'] }}</strong>, at
                        <strong>{{ $data['venue_name'] }}</strong>, on
                        ...
                        .
                        <br><br>
                        To view the address, notes and other resources related to this event, please click on "Links
                        &amp; resources" under <a href="{{ route('dashboard.events') }}">your events</a>.
                        <br><br>
                        For more information regarding this event please <a href="{{ $data['event_link'] }}">click here.</a>
                        <br><br>
                        For further details about your booking, please refer to our <a
                        ...
                        If you have any questions, please call us on 010 593 0466 or email <a
                                href="mailto:admin@accountingacademy.co.za?subject={{ $data['event_name'] }}">admin@accountingacademy.co.za</a>.
                                <br><br>
                                            ...
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="{{ route('dashboard.events') }}"
                                                       style="color: #fff; text-decoration: none;">View my events</a>
                                                </div>
                                            </td>
                                        </tr>
...
<table class="container590" border="0" height="75" width="600" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td align="center"
            style="color:#c6c6c6; display: block; text-decoration: none; outline: none; border: none;font-size: 14px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400;">
            <br/>
