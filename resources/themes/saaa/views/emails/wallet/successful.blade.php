            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br><br>
                        Thank you for making a payment to your wallet. <br>
                        Your funds has been successfully allocated to your wallet and is now available for you to use.
                        <br>
                        <br>
                        Your total available funds is <strong>R{{ number_format($user->wallet->amount, 2) }}</strong>
                        <br>
                        <br>
