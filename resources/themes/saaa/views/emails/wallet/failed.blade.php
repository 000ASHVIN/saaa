        ...
        <td border="0" align="center">
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Your Topup was successful.</td>
                </tr>
                <tr>
                    <td height="40"></td>
                </tr>
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br><br>
                        Kindly note that your transaction has failed. <br>
                        To choose an alternative card in order to top up your wallet, Please go to the My Billing tab and select a different credit card and set as your primary card.
                        <br>
                        <br>
                        Your total available funds is <strong>R{{ $user->wallet->amount }}</strong>
                        <br>
                        <br>
                        Should you have any queries, please feel free to contact us on 00 or send us an email to <a
                                href="mailto:info@accountingacademy.co.za">info@accountingacademy.co.za</a> for assistance.
                                <br>
                        <br>
