            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br><br>
                        Thank you for ordering <strong>{{ $user->products->last()->topic }}</strong>. <br><br>
                        If you have selected Purchase Order, please login to your profile now and settle your purchase order.
                        <br>
                        <br>
                        If you have paid this order already with your credit card, kindly ignore the above and see this as a confirmation of your order.
                        <br>
                        <br>
