        ...
        <td border="0" align="center">
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Purchase Order Outstanding</td>
                </tr>
                <tr>
                    <td height="40"></td>
                </tr>
                <tr align="left"
                    ...
                    <td>
                        Dear {{ ucwords(strtolower($order->first_name)) }} {{ ucwords(strtolower($order->last_name)) }}
                        <br><br>
                        Order Reference: #{{ $order->reference }}
                        <br>
                        <br>
                        This is a friendly reminder that your order #{{ $order->reference }} is still outstanding and will be cancelled in 7 days if no payment was received.
                        <br>
                        <br>
                        If you have already made payment for #{{ $order->reference }}, please inform us immediately.
                        <br>
                        <br>
                        Should you have any queries, please feel free to contact us on 010 593 0466 or send us an email to <a
