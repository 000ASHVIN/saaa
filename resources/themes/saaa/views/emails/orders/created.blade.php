    ...
    <tr>
        <td border="0" align="center">
            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    style="color: #666666; font-size: 14px; font-family: Helvetica, Arial; font-weight: 400; line-height: 20px;">

                    <td>
                        Dear {{ $user->first_name }} {{ $user->last_name }}
                        <br><br>
                        A new purchase order has been generated on your profile and is attached to this email.
                        <br><br>
                        You can also download the latest purchase order from your dashboard. <a href="{{ route('dashboard.invoices') }}">dashboard</a>.
                        <br><br>
                        To settle a purchase order, from your dashboard choose Purchase Orders and click on the settle button.
                        <br><br>
                        If you have any questions, please call us on 010 593 0466 or email <a
                            ...
                            <tr>
                                ...
                                <td>
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0"
                                           class="main_color" bgcolor="173175"
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="color: #fff; font-size: 13px; font-family: Helvetica, Arial; font-weight: 400; line-height: 22px;">
                                                <!-- ======= main section button ======= -->

                                                <div style="line-height: 22px;">
                                                    <a href="{{ route('dashboard.invoices') }}"
                                                       style="color: #fff; text-decoration: none;">View all invoices</a>
                                                </div>
                                            </td>
                                        </tr>
...
<table class="container590" border="0" height="75" width="600" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td align="center"
            style="color:#c6c6c6; display: block; text-decoration: none; outline: none; border: none;font-size: 12px; font-family: Helvetica, Arial; font-weight: 400;">
            <br/>

            <p>
                © {{ \Carbon\Carbon::today()->year }} SA Accounting Academy. All Rights Reserved.
            </p>
        </td>
    </tr>
