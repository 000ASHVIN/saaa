...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table" mc:repeatable=""
       style="max-width: 800px" width="750">
    <tbody>
    <tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
       style="background: no-repeat center top / 100% 100%; max-width: 800px" width="750">
    <tbody>
    <tr>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td class="content space_class" height="10" style="font-size: 1px; line-height: 1px" width="750"> </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td bgcolor="#ffffff" class="content white_bg" style="background: #ffffff" width="750">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td class="padding" width="20"> </td>
                    <td align="left" class="content_row" width="760">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr>
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    style="color:#000000; font-family: 'Helvetica'; font-size: 14px; font-weight: 400; line-height: 23px; width: 100%">

                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Dear {{ ucwords(strtolower($rep['name'])) }}</p>

                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Please note that the following client does not have any Invoices, Transactions,
                                        <br> Purchase Orders or Store Orders available on their dashboard.
                                    </p>

                                    <ul style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Name: {{ ucwords(strtolower($user['first_name'].' '.$user['last_name'])) }}</li>
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Status: {{ ucwords($user['status']) }}</li>
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">ID Number: {{ ($user['id_number'] ? : "N/A") }}</li>
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Email Address: {{ ($user['email'] ? : "-")}}</li>
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Cellphone Number: {{ ($user['cell'] ? : "N/A") }}</li>
                                        <li style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Alternative Cell number: {{ ($user['alternative_cell'] ? : "N/A") }}</li>
                                    </ul>

                                    <p>If you are currently logged into the system (SA Accounting Academy) with your <strong>Administrator</strong> account,
                                        <br> <a href="{{ route('admin.members.show', $user['id']) }}">Click Here</a> to view this profile
                                    </p>

                                    <p><span style="color:#000000;"><span style="font-family:helvetica;"><span
                                                        style="font-size:14px;">Kind Regards,
                                        <br> SA Accounting Academy</span></span></span></p>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td class="content height40 space_class" height="10" style="font-size: 1px; line-height: 1px" width="750"> </td>
    </tr>
    </tbody>
</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td bgcolor="#173175" class="content red_bg" style="background: rgb(23, 49, 117);" width="750">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                <tr>
