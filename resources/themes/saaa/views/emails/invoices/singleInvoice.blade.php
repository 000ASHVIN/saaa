            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" width="514"><!-- start space -->
                ...
                <tr align="left" style="color: #666666; font-size: 14px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400; line-height: 20px;">
                    <td>Dear {{ $user->first_name }}<br />
                        <br />
                        Please note that there is an invoice outstanding on your account and is immediately payable.
                        <br>
                        <br>
                        If you have already settled this invoice, please send proof of payment to <a href="mailto:payments@accountingacademy.co.za">payments@accountingacademy.co.za</a> in order for us to ensure that the payment is allocated.
                        <br>
                        <br>
                        <table class="table" align="center" border="1" cellpadding="1" cellspacing="1" style="width:550px;">
                            ...
                            <tr align="center">
                                ...
                                <td align="center">R{{ number_format($invoice->transactions->where('type', 'debit')->sum('amount') - $invoice->transactions->where('type', 'credit')->sum('amount'), 2) }}</td>
                            </tr>
                    ...
                    <td>
                        <table border="0">
                            ...
                            <tr>
                                <td width="20">&nbsp;</td>
                                <td>
                                    <table align="center" bgcolor="173175" border="0" cellpadding="0" cellspacing="0" class="main_color" style="border-radius: 5px;" width="200">
                                        <tbody>
                                        <tr>
