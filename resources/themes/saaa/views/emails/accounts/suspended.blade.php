                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    @if(! $user->force_suspend)
                                        <p>
                                            Dear {{ $user->first_name }} {{ $user->last_name }} <br>
                                            <strong>Account Suspended: {{ date_format(\Carbon\Carbon::parse($user->suspended_at), 'd F Y') }}</strong>
                                            <br>
                                            <strong>Account Balance: R{{ number_format($user->balanceInRands(), 2) }}</strong>
                                        </p>

                                        <p>
                                            We hereby regret to inform you that your account is now suspended due to non-payment of invoices.
                                        </p>

                                        <p>
                                            If you have any queries regarding your outstanding balance please contact our accounts department on 010 593 0466 or
                                            send an email to payments@accountingacademy.co.za.
                                        </p>

                                        <p>
                                            Please make an EFT payment for the outstanding amount with immediate effect alternative please login to your account and settle your outstanding invoices with your credit card.
                                        </p>

                                        <p><strong>Our Banking Details:</strong></p>
                                        <p>
                                            Bank: ABSA Bank <br>
                                            Account Holder: SA Accounting Academy<br>
                                            Account Number: 4077695135<br>
                                            Branch Code: 632005 <br>
                                            <strong>Reference: #{{ $user->overdueInvoices()->first()->reference }}</strong><br>
                                        </p>
                                    @else
                                        <p>
                                            Dear {{ $user->first_name }} {{ $user->last_name }} <br>
                                        ...
                                        <p>
                                            Kindly note that this mail serves as confirmation of Temporary suspension of your Profile up until proof of payment is received as discussed telephonically.
                                        </p>

                                        <p>
                                            Your profile will be made Active as soon as payment is received.
                                        </p>
                                    @endif

                                    <p><span style="color:#000000;"><span style="font-family:helvetica;"><span
                                                        style="font-size:14px;">Kind Regards,<br/>
									SA Accounting Academy</span></span></span></p>
