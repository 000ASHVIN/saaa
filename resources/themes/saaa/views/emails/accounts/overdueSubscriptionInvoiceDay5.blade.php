                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p>Thank you for registering for our CPD subscription package. You have
                                        selected to pay via EFT. Please note that payment is now
                                        due. Please can you make payment immediately and forward proof of payment to
                                        <a href="mailto:payments@accountingacademy.co.za">payments@accountingacademy
                                            .co.za</a> <br/>
                                        <br/>
                                        To view your invoice, please log onto your profile, click on My Invoices and
                                        click on the blue View button on the right hand side of the relevant invoice.
                                         <br/>
                                        <br/>
                                        If you have any queries regarding your subscription, please contact us on 010
                                        593 0466 or <a href="mailto:admin@accountingacademy.co.za">admin@accountingacademy.co.za</a> <br/>
                                        <br/>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" class="weight_400 text_center"
                                                ...
                                                Copyright {{Date('Y')}} SA Accounting Academy
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
