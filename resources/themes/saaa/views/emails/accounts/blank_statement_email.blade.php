                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Dear {{$user['first_name']}}</p>
                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">{!! nl2br($emailMessage) !!}</p>

                                    <p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px">Should you wish to view your invoices online, kindly login to your online profile and click on the "My Invoices" tab from the side navigation.</p>
