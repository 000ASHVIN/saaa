                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p style="text-transform: capitalize">
                                        Dear {{ $user['first_name'] }} {{ $user['last_name'] }}</p>
                                    <p>I am writing to you with a heavy heart. </p>
                                    <p>
                                        At the moment we have outstanding CPD fees exceeding R1 900 000. Because we
                                        offer CPD subscription at cost plus a 10% markup, we are very dependent on our
                                        subscribers to pay us when due.
                                    </p>

                                    <p>
                                        If we fail to collect the outstanding amounts by this Friday, then we will not
                                        be able to pay our dedicated staff, presenters and CPD venues by the end of this
                                        month. Worst case, we may even be forced to enter into liquidation.
                                    </p>

                                    <p>
                                        Will you please assist and pay your outstanding CPD fees this week. I do
                                        understand that you may also experience similar challenges, so please do let me
                                        know if you would like to structure a payment plan.
                                    </p>

                                    <p>
                                        Your outstanding amount is currently R{{ number_format($user['balance'] / 100, 2) }}.
                                    </p>

                                    <p>
                                        You can view your invoices and also load your debit instructions
                                        <a href="https://accountingacademy.co.za/dashboard/verify_account/{{Crypt::encrypt($user['email'])}}">here</a> before <strong>Friday, 31 March 2017</strong>
                                    </p>

                                    <p>
                                        Also note that all your CPD events and course material will be made available to you
                                        and can be accessed online once you have settled your outstanding invoices.
                                    </p>

                                    <p>
                                        Thank you for helping us to remain your CPD partner of choice.
                                    </p>
                                    ...
                                    <p>
                                        <span style="color:#000000;">
                                            <span style="font-family:helvetica;">
                                                <span style="font-size:14px;">Warm regards, <br/>
									                    Stiaan Klue <br>
                                                        Group Chief Executive
                                                        <br>
                                                        Incorporating, SA Accounting Academy <br><br>
                                                    <img src="http://imageshack.com/a/img924/4823/mEPf0R.jpg" alt="Logo">
                                                </span>
                                            </span>
                                        </span>
                                    </p>
