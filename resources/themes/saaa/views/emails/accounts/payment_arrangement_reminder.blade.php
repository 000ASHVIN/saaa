...
<p style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: black">This is a friendly reminder regarding your payment for the amount of R{{ number_format($invoice->transactions->where('type', 'debit')->sum('amount') - $invoice->transactions->where('type', 'credit')->sum('amount'), 2, ".", "") }} to be settled by {{ $invoice->ptp_date }}.  </p>
