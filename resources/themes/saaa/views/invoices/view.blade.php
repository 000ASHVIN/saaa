...
<table style="width: 90%">
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 10px; font-family: Helvetica, Arial; font-size: 12px; color: white" bgcolor="#173175">R {{ number_format($invoice->balance, 2) }}</td>
    </tr>
...
<table width="90%">
    ...
    <tr>
        ...
        <td style="width: 40%; font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #173175; padding-bottom: 10px;">BANKING DETAILS</td>
		       <td style="width: 0px"></td>
        <td style="width: 40%; font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #173175; padding-bottom: 10px;">SNAPSCAN</td>
    </tr>
