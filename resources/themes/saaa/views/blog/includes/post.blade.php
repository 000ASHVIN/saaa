<div class="col-md-4">
    <div class="blog-post-item">
        ...
        <h4 class="blog-post-item-title"><a href="{{ route('news.show', $post->slug) }}">{{ str_limit($post->title, 40) }}</a></h4>

        <ul class="blog-post-info list-inline">
            <li>
                <i class="fa fa-clock-o"></i>
                <span class="font-lato">{{ date_format(\Carbon\Carbon::parse($post->publish_date?$post->publish_date:$post->created_at), 'F d') }}</span>
            </li>
            <li>
