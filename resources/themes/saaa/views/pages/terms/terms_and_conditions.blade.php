    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>
                    These terms and conditions will apply to all bookings, engagements with, attendance or use of a
                    seminar, conference, workshop, CPD subscription service, online learning services, online profile or
                    other similar service or product hosted, offered, organised or to be hosted, offered or organised by
                    South African Accounting Academy (Pty) Ltd or any of its representatives and marketed as such ('the
                    Event').
                </p>
                ...
                <p>
                    ...
                    <br>
                    2.2.	“Profile” means Internet Identity with SAAA. <br>
                    2.3.	“SAAA” means South African Accounting Academy, a private company with registration number 2007/020344/07 and principal place of business at Broadacres Business Centre, hereinafter referred to as “SAAA”; <br>
                    2.4.	“the Client” means a person or company who uses the services of SAAA. <br>
                    2.5.	“Personal Data” means the data which relates to a natural person who can be identified from that data or from that data and other information and which is provided to SAAA by the Client. <br>
                    2.6.	“CPD Subscription” means monthly/annual continuous professional development subscription package <br>
                </p>
                <p><b>3.	BOOKINGS AND CONFIRMATION</b></p>
                <p>
                    ...
                    3.3.	A booking will be deemed to be finalised once payment has been received. <br>
                    3.4.	If a client has booked an event but does not receive a confirmation 7 (seven) working days prior to the Event date, it is the responsibility of the client to contact SAAA on 010 593 0466 or admin@accountingacademy.co.za and follow-up on the booking. <br>
                    3.5.	Registration closes 24 (twenty-four) hours prior to each event. Late registrations shall only be permitted if the client has made prior arrangements with admin@accountingacademy.co.za. <br>
                    3.6.	Venues, times, topics, presenters, programme offerings, and online schedules are subject to change without notice and are determined solely at the discretion of SAAA. <br>
                </p>
                <p><b>4.	PAYMENT</b></p>
                <p>
                    4.1.	Payment for an event can be made in any of the following manner: <br>
                    4.1.1.	by electronic funds transfer (EFT); <br>
                    4.1.2.	direct cash deposit to the bank account of SAAA; or <br>
                    4.1.3.	by credit/debit card using the payment facility on the SAAA website. <br>
                    ...
                    4.4.	No client will be permitted entrance to the event without proof of payment having been received in advance or presented to an SAAA staff member on the day. For late registrations, full payment must be made at the venue via SnapScan. No cash, cheque, credit or debit card payments will be accepted. <br>
                    4.5.	EFT Payments <br>
                    4.5.1.	Once a payment has been made, clients must submit proof of same, clearly stating the invoice number that appears on the invoice. <br>
                    4.5.2.	Proof of payment should be emailed to accounts@accountingacademy.co.za <br>
                ...
                <p>
                    <b>5.1.	Event Cancellations by SAAA </b><br>
                    5.1.1.	The event may be cancelled by SAAA, without prior notice. In this circumstance the client has the option to attend the live webinar or watch the recording of the event online or transfer the booking to another event. In the case that the client does not want to take up any of the above options, only the attendance fees will be refunded. <br>
                    5.1.2.	The client shall not be entitled to receive a refund of the event fee except in circumstances where: <br>
                    5.1.2.1.	there was an overbooking by SAAA; or <br>
                    5.1.2.2.	the Event was cancelled by SAAA. <br><br>
                    <b>5.2.	Cancellations by the Client </b><br>
                    5.2.1.	Clients wishing to cancel an event booking must send a written cancellation notice to admin@accountingacademy.co.za <br>
                    5.2.2.	Telephonic cancellations will not be accepted. <br>
                    5.2.3.	No cancellation fee shall be levied by SAAA on cancellation of a booking for reasons of serious illness, hospitalisation or death <br><br>
                    <b> 5.3.	Paid Invoices </b><br>
                    5.3.1.	Should a client cancel a confirmed booking, being a webinar or Seminar, SAAA reserves the right to charge a cancellation fee, unless the event is cancelled within 10 (ten) working days of the original confirmation of the event. <br>
                    5.3.2.	All cancellations must be done in writing and sent via email to accounts@accountingacademy.co.za from the email address the client registered with on the SAAA website.<br>
                    ...
                    5.3.5.	Any refunds due will be made within 10 (ten)working days after written receipt of the cancellation of an event.<br>
                    5.3.6.	Banking details of the account into which the refund must be paid must be sent via email to  accounts@accountingacademy.co.za<br><br>
                    <b>  5.4.	Unpaid Invoices</b><br>
                    5.4.1.	Upon confirmation of an event, SAAA reserves the right to charge a Penalty fee unless the event is cancelled within 3 (three) working days of the original confirmation of the event with a request in writing via email to accounts@accountingacademy.co.za from the email address the client registered with on the SAAA website.<br>
                    5.5.	If a client fails to cancel the booking as set out above, he/she will be liable for the full payment. Once paid, a recording of the event will automatically be made available via the client’s profile page as a courtesy from SAAA.<br>
                ...
                <p><b>6.	CPD SUBSCRIPTIONS</b></p>
                <p>
                    6.1.	SAAA will provide the CPD subscription service to you on a pre-paid basis. <br>
                    ...
                    6.7.1. Yearly Subscription Plans: The service is offered on a once off (prepaid) annual basis. Payment will therefore be upfront via EFT, credit card or by debit order only for the 12 month period. At the end of the 12 month period the plan will be converted to a monthly subscription plans. Should you wish to continue with the Yearly Subscription Plans, please notify us electronically by emailing admin@accountingacademy.co.za 1 month before expiry date. Should you wish to cancel, please refer to section 6.13 and 6.14 below.<br>
                    6.7.2. Monthly Subscription Plans: The service is offered on a continual monthly basis with no specified end date. Payments will therefore be on a monthly basis via credit card or by debit order only. Should you wish to cancel, please refer to section 6.13 and 6.14 below.<br>
                    6.8.	You will be able to join all webinars through your profile page, so there is no need to register for them. Recordings of the webinars will be made available for viewing to all subscribers within 7 (seven) working days of the date of the webinar.<br>
                    6.9.	The CPD Subscription entitles you to view recorded training sessions online. You have an option to also attend a selected number of events per year, as part of your package. If you wish to attend a seminar in person, it is your responsibility to register for the event in advance so that we can advise the venue of our expected client numbers and to accommodate any dietary requirements. Please notify us of any changes, cancellations (events) 3 (three) working days in advance in writing. If not, a penalty fee of R500.00 will be charged. If you do notify us 3 (three) working days in advance, a recording of the event and CPD assessment will automatically be made available via your profile page after the event has taken place. SAAA cannot guarantee that you will be allocated a seat to an event. Events are seated on a first come first serve basis.<br>
                    6.10.	We cannot guarantee that every seminar will be hosted at all venues and if the client is unable to attend an event or it is not available in his/her area, he/she has the option of attending a webinar for that event. If the date of the webinar is not convenient, then a recording of the event and CPD assessment will be made available as per clause 7.9 above. If an event in your area for which you have registered is cancelled, then the recording will be made available as per clause 7.9. above, unless you wish to attend the event in another area, in which case you must notify us electronically by emailing admin@accountingacademy.co.za at least 3 (three) working days prior to the event taking place.<br>
                    ...
                    6.13.	If you wish to cancel your CPD subscription, you must notify us in writing of your intention to terminate with a valid reason. A 27 (twenty-seven) day notice period will apply.<br>
                ...
                <p>
                    ...
                    8.4.	A request for substituting a client for another must be submitted to SAAA in writing 24 (twenty-four) hours before the date of the event.<br>
                    8.5.	No late substitution requests will be considered.<br>
                    8.6.	Requests for substitution must be sent to admin@accountingacademy.co.za<br>
                </p>
                <p><b>9.	TRANSFERS</b></p>
                <p>
                    9.1.	Requests for the transfer of a booking to a different event venue or date ('Transfer') must be made in writing to SAAA.<br>
                    9.2.	Requests for transfers must be sent to admin@accountingacademy.co.za<br>
                ...
                <p>
                    10.1.	In no event shall SAAA be liable for any loss of contracts, profits, anticipated savings, revenue, goodwill, business, loss or corruption of data or software programs, financing expenses, interruption in the use or availability of data, stoppage to other work or consequential losses, nor for any indirect losses.<br>
                    10.2.	SAAA and the Client hereby indemnify each other against damage to tangible property, whether personal or real, and death or injury to persons to the extent caused by the negligence of the other party.<br>
                    10.3.	The Client understands and accepts that SAAA consistently develops its training courses in line with evolving best practices.  SAAA reserves the right to make changes to the published and/or advertised course content in connection with its training services without prior notice to the Client.<br>
                </p>
                <p><b>11.	INTELLECTUAL PROPERTY</b></p>
                <p>
                    All intellectual property rights, including copyright, patents and design arising in connection with this Agreement shall belong to and remain vested in SAAA and the Client shall execute any document necessary for this purpose.
                </p>
                ...
                <p>
                    ...
                    12.2.	In the unlikely event of the above, SAAA will endeavour to reschedule at a mutually convenient date and/ or venue and SAAA will not be liable for any loss or expenses caused to the Client.<br>
                </p>
                ...
                <p>
                    ...
                    13.2.	SAAA designates the address Broadacres Business Centre as its domicilium citandi et executandi ("domicilium") for any notice/s, the serving of any process and for any other purposes arising from this Agreement.<br>
                </p>
                <p><b>14.	ENTIRE AGREEMENT</b></p>
                <p>
                    14.1.	This Agreement sets out the entire agreement between the parties in relation to the subject matter hereof and supersedes all previous arrangements, agreements and representations whether written, oral or implied between the Client and SAAA relating to the Services. <br>
                ...
                <p>
                    ...
                    15.2.	The parties agree to the jurisdiction of the Magistrate’s Court in relation to any legal proceedings which may result from the Agreement, provided that SAAA is entitled in its discretion to institute any such legal proceedings in any other competent court. <br>
                </p>
                <p><b>16.	COSTS</b></p>
                <p>
                ...
                <p>
                    SAAA is not a Financial Service Provider (FSP) and does not provide financial advice. Any information provided regarding Professional Indemnity Insurance (PI) is merely a description and should not be understood as advice. SAAA will refer all PI Insurance matters to the Insurance Broker.
                </p>
                <p><b>18.	PRIVACY POLICY</b></p>
                <p>
                    18.1.	SAAA collect’s no personal information about you when you visit this website, except where otherwise stated, unless you choose to provide this information to us. However, we collect, and store certain information automatically as follows:<br>
                    ...
                    18.3.	Visitors to the SAAA website have no explicit or implicit expectation of privacy. The website uses software programs to monitor network traffic to identify unauthorised attempts to change, delete information or otherwise cause damage. Any or all visits to the SAAA website are subject to these conditions.<br>
                    ...
                    18.5.	This information is NOT shared with anyone beyond the support staff for the SAAA website, except as required for site security purposes, to ensure that the SAAA website remains available to all users and when required by law enforcement investigation. We use the information only as a source of anonymous statistical information and no other attempts are made to identify client users or their usage habits.<br>
                </p>
