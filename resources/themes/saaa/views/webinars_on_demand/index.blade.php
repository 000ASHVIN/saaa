...
<section class="alternate" style="background-image: url('/assets/frontend/images/demo/wall2.jpg');">
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 category-column">
                        <div class="category-block">
                            <a href="#" data-scroll="best_seller_id">
                                <img src="{{ asset('/assets/themes/saaa/img/wod_best_sellers.jpg') }}">
                                {{-- <div class="card_wod">
                                    <h3>Best Sellers</h3>
                    ...
                    <div class="col-sm-6 col-md-3 category-column">
                        <div class="category-block">
                            <a href="#" data-scroll="new_releases_id">
                                <img src="{{ asset('/assets/themes/saaa/img/wod_new_releases.jpg') }}">
                                {{-- <div class="card_wod">
                                    <h3>New Releases</h3>
                    ...
                    <div class="col-sm-6 col-md-3 category-column">
                        <div class="category-block">
                            <a href="#" data-scroll="webinar_series_id">
                                <img src="{{ asset('/assets/themes/saaa/img/wod_webinar_series.jpg') }}">
                                {{-- <div class="card_wod">
                    ...
                    <div class="col-sm-6 col-md-3 category-column">
                        <div class="category-block">
                            <a href="#" data-scroll="free_webinar_id">
                                <img src="{{ asset('/assets/themes/saaa/img/wod_free_webinar.jpg') }}">
                                {{-- <div class="card_wod">
                                    <h3>Free Webinars</h3>
            ...
            <div class="search-category webinar_section">
                <div class="col-md-12">
                    @if (count($best_seller))
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        function checkIndicatorHeight() {
            if($('.card_wod .indicator').height() > 70) {
                var height = '49px';
                var right = '-8px';
            } else {
                var height = '35px';
