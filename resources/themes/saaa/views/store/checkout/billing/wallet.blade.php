<div class="panel panel-default" v-if="forms.checkout.paymentOption == 'wallet' && user.availableWallet != 0">
...
<div class="panel panel-default" v-if="forms.checkout.paymentOption == 'wallet'">
    <div class="panel-body">
...
<div class="row"  v-if="forms.checkout.paymentOption == 'wallet'">
    <div class="col-md-12">
