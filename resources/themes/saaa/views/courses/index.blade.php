...
@section('meta_tags')
    @if($courses->currentPage() == 1)
        <title>Online Courses | Enroll Now | {{ config('app.name') }}</title>
     @else
        <title>Online Courses | Page {{ $courses->currentPage() }} | {{ config('app.name') }}</title>
    @endif
@endsection
...
<section id="slider" class="hidden-sm hidden-xs course_banner_img">
    <div style="text-align: center">
        <img src="{{ url('assets/themes/saaa/img/courses_header.png') }}" alt="Videos"  style="max-height:350px;" class="course_banner_img">
    </div>
                ...
                <div class="col-md-8">
                    <div class="text-center">
                        ...
                        <div class="form-group">
                            <button onclick="spin(this)" class="btn-block btn btn-default"><i class="fa fa-search"></i> FIND MY COURSE</button>
                        {!! Form::close() !!}
                        </div>  
                    </div>
                </div>
...
<div class="container">
            ...
            <div class="col-xs-6 col-md-4 category-column">
                <div class="category-block">
                    <a href="#" data-scroll="qualifications">
                        <img src="{{ url('assets/themes/taxfaculty/img/1._Qualifications__Programmes_v02-cropped.jpg') }}
                        ">
                    </a>
                </div>
            </div>
            <div class="col-xs-6 col-md-4 category-column">
                <div class="category-block">
                    <a href="#" data-scroll="professional">
                        <img src="{{ url('assets/themes/taxfaculty/img/2._Professional_Certificates-cropped.jpg') }}">
                    </a>
                </div>
            </div>
            <div class="col-xs-6 col-md-4 category-column">
                <div class="category-block">
                    <a href="#" data-scroll="short_courses">
                        <img src="{{ url('assets/themes/taxfaculty/img/3._Short_Courses_v02-crooped.jpg') }}">
                    </a>
                </div>
            </div>
        </div>
    ...
    <h3 class="title">COURSES 2021</h3>
    <div class="row">
        <div class="col-md-12">
    ...
    {{-- <div class="row">
        <div class="col-md-12">
            <div class="category-heading" id="qualifications">
                <h2 class="heading">Qualifications and Programmes</h2>
