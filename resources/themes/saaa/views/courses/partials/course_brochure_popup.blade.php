<div class="modal fade course_brochure_popup" id="course_brochure_popup{{ $course->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content brochure-popup-background">
        ...
        <div class="modal-body">
          {!! Form::open(['method' => 'post', 'route' => 'courses.course_process']) !!} 
