        ...
        <div class="search-header">
            <section id="slider">
                <section class="search-box" style="padding: 10px;">
                    <div class="row">
                        {!! Form::open(['method' => 'get', 'route' => 'resource_centre.technical_faqs.search']) !!}
                            ...
                            <div class="col-md-8">
                                <div class="text-center">
                                    ...
                                    <div class="form-group @if ($errors->has('title')) has-error @endif">
                                        {!! Form::input('text', 'search', isset(request()->search)?request()->search:'', ['class' => 'form-control', 'placeholder' => 'Search for content', 'style' => 'text-align:center']) !!}
