                    ...
                    @foreach($assessments as $assessment)
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="{{ route('dashboard.assessments.lastresult',[$ticket->id, $assessment->id]) }}" class="btn btn-primary btn-xs {{ count($allAttempts[$assessment->id]) > 0 ? '' : 'disabled' }}">Last Result</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
