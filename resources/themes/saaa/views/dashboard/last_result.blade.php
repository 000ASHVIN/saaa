                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                {{-- @foreach($answers as $answer)
                                    <tr>
                                        <td>{{ $answer->question->sort_order }}</td>
                                        <td class="last_result_question">{!! $answer->question->description !!}</td>
                                        <td class="last_result_question">{{ $answer->option->description }}</td>
                                    </tr>
                                @endforeach --}}
