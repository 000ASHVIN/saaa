        ...
        <td border="0" align="center">
            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Your Import has been completed!</td>
                ...
                <tr align="center"
                    style="color: #666666; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: 400; line-height: 20px;">

                    <td style="font-size: 14px; font-family: Helvetica, Arial, sans-serif">
                        <p>Dear Admin</p>
                        <p>Please note that your import has been completed for <br> Webinar: <strong>{{ $event->name }}</strong></p>
                    </td>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="https://my.sendinblue.com/users/list/id/{{$folderId}}"
                                                       style="color: #fff; text-decoration: none;">View Contacts</a>
                                                </div>
                                            </td>
                                        </tr>
