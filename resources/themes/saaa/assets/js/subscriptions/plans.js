...
Vue.component('app-subscriptions-screen-plan', {
    ...
    ready() {
        ...
        if (this.before_selected_plan && this.before_selected_plan.package_type == "business") {
            this.makeactive("business", "business-accountant-in-practice");
        }

        if (this.before_selected_plan && this.before_selected_plan.package_type == "trainee") {
            this.makeactive("trainee", "Trainee-Accountant");
        }
