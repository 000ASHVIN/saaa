...
require('./../orders/course_order');
require('./../orders/plan_order');
require('./../legislation');
require('./../orders/pay');
...
require('./../subscriptions/upgrade_subscription');
require('./../admin_pay');

require('./../support_ticket/support_ticket');
require('./../orders/resource_search');
require('./../orders/company_renew');
require('./../course/sync_course');
require("./../chats/chat-list");