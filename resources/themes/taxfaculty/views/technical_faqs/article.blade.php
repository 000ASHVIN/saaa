            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <p style="margin-top: 30px; font-size: 12px;"><em><strong>Disclaimer: </strong>Nothing in this query and answer should be construed as constituting tax advice or a tax opinion. An expert should be consulted for advice based on the facts and circumstances of each transaction/case. Even though great care has been taken to ensure the accuracy of the answer, The Tax Faculty do not accept any responsibility for consequences of decisions taken based on this query and answer. It remains your own responsibility to consult the relevant primary resources when taking a decision.</em></p>
                    </div>
