            ...
            @foreach($faqCategories->chunk(3) as $chunk)
                <div class="row">
                    @foreach($chunk as $folder)
                        <div class="col-md-4">
                            <div class="border-box margin-bottom-10" style="background-image: url('/assets/frontend/certificates/cpd/images/bg.jpg'); background-size: cover; text-align: center; min-height: 200px; display: -webkit-flex; -webkit-align-items: center; border: 1px solid #8cc03c ;">
                                <div class="center-block">
                                    <h4 style="vertical-align: center; width: 245px; color: #8cc03c; min-height: 45px">{{ ucwords($folder->name) }}</h4>
                                    <hr>
                                    <p style="vertical-align: center; width: 250px; color: #8cc03c; min-height: 100px">{{ $folder->description }}</p>
                                    <hr>
                                    <div class="form-inline">
                                        <button style="background: white; color: #8cc03c;" class="btn btn-primary">0 Articles</button>
