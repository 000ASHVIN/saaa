        ...
        <div class="row">
            <div class="col-md-8 verticalLine">
                <div style="background-color: white; padding: 10px; border: 1px solid #e3e3e3">
                    ...
                    <ul>
                        <li>Standard licence – <strong>R5 246</strong> annual fee.</li>
                        <li>Exclusive offer to SAAA members – <strong>R4 459</strong> for first annual licence fee.</li>
                        <li>XBRL tagging application for Excel financial statements – <strong>R1 150</strong>.</li>
                    </ul>
                    <p><strong>Steps to get your first DRAFTWORX licence at 15% discount.</strong></p>
                    <ul>
                        <li>Login to your profile on {{ url('/') }}.</li>
                    ...
                    <br>
                    <br>
                    <p><strong>Cost – Black Friday only</strong></p>
                    <ul>
                        <li>Standard licence – R5 246 annual fee.</li>
                        <li>Exclusive offer to SAAA members – R4 099 for 1st year licence fee.</li>
                        <li>XBRL tagging application for Excel financial statements – R1 150.</li>
                        <li>Steps: Login , Go to My Rewards, Select Draftworx, Complete order form.</li>
                    </ul>
