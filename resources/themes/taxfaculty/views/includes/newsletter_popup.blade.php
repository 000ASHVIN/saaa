        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
               ...
               <form class="validate" action="/newsletter/subscribe" method="post"
                  ...
                  @endif
                  <div>
                    <p style="margin-top: 10px;">By subscribing to our mailing list you accept our <a href="{{ route('terms_and_conditions') }}" target="_blank" class="newsletter-link terms">Terms of Service</a> and <a href="{{ route('privacy_policy') }}" target="_blank" class="newsletter-link privacy">Privacy Policy</a></p>
                  </div>
                   <div class="input-group-addon" style="border: none; padding: 2px; color: white; background-color: #8cc03c; border-color: #8cc03c;">
                       <button class="btn btn-success btn" style="border: none; padding: 2px; color: white; background-color: #8cc03c; border-color: #8cc03c;" type="submit"> <i class="fa fa-envelope"></i> Subscribe to newsletter </button>
                   </div>
               </form>
               <!-- /Newsletter Form -->
