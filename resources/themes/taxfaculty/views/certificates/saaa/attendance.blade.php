...
<table class="certificate" width="100%">
    <tr style="height: 140px;">
        <td class="certificate-logo">
            @if($pdf)
                <img src="{{ asset('assets/frontend/certificates/cpd/images/logo.png') }}" width="100%" alt="{{settings('company-name')}}">
            @else
                <img src="{{ asset('assets/frontend/certificates/cpd/images/logo.png') }}" alt="{{settings('company-name')}}" width="100%">
            @endif
        </td>
    </tr>
    <tr>
