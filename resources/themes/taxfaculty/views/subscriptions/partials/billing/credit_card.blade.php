<div class="panel panel-default" v-if="forms.subscription.paymentOption == 'cc'">
    ...
    <div class="panel-body">
        ...
        <ul class="list-group" v-if="user.cards.length > 0 && ! readyForThreeDs">
            <li class="list-group-item" v-for="card in user.cards">
            	<label>
            		<input type="radio" name="card" v-model="forms.subscription.card" :value="card.id" :checked="card.id == user.primary_card">
            		@{{ card.number }}
            	</label>
            	<span>
        ...
        <div v-if="(! forms.subscription.card || addingNewCard) && ! readyForThreeDs">
        	<hr>
        ...
        <div v-if="readyForThreeDs">
        	<div class="alert alert-success">
                <p>
                    <i class="fa fa-lock"></i> Your Credit Card is enrolled for 3DS Secure verification. In order for us to process your credit card, you are required to verify ownership of your credit card. In order to verify your ownership, click the <b>"Proceed to Verification"</b> button below. 
                </p>
            </div>
