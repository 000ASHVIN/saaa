<div class="modal fade" id="need_help_subscription_cyber" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                <h4 class="modal-title">I need help with the 50% discount catch-up package</h4>
            </div>
