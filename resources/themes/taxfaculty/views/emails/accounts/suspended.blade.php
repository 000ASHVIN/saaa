                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    @if(! $user->force_suspend)
                                        ...
                                        <p>
                                            If you have any queries regarding your outstanding balance please contact our accounts department on 012 943 7002 or
                                            send an email to {{ config('app.email') }}.
                                        </p>
                                        ...
                                        <p>
                                            Bank: ABSA Bank <br>
                                            Account Holder: {{ config('app.name') }}<br>
									...
									{{ config('app.name') }}</span></span></span></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="height15 space-class" height="20"> </td>
