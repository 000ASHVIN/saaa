                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Thank you for choosing {{ config('app.name') }}.</p>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td bgcolor="##8cc03c" class="content red_bg" style="background: #8cc03c" width="600">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                <tr>
