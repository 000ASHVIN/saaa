                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p>If you are currently logged into the system ({{ config('app.name') }}) with your <strong>Administrator</strong> account,
                                    ...
                                    <p><span style="color:#000000;"><span style="font-family:helvetica;"><span
                                        ...
                                        <br> {{ config('app.name') }}</span></span></span></p>
                                </td>
                            </tr>
                            <tr>
                                <td class="height15 space-class" height="20"> </td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td bgcolor="##8cc03c" class="content red_bg" style="background: #8cc03c" width="750">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                <tr>
