...
<p style="font-size: 14px; font-family: Arial">Thank you for enquiring about DRAFTWORX, via {{ config('app.name') }} and Auxilla.</p>
...
<p style="font-size: 14px; font-family: Arial">
    ...
    <strong>w</strong> <a href="#">{{ url('/') }}/sponsors</a> <br>
