                                ...
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p>As per our emails from last year advising you that your CPD subscription will
                                        ...
                                        To view your invoice, please click <a
                                                href="{{ url('/') }}/dashboard/invoices"><u>here</u></a>.<br/>
                                        <br/>
                                        ...
                                        To pay by direct debit, please go onto your profile on <a
                                                href="http://97.107.128.205/index.php/campaigns/rr539nxsle004/track-url/ga346labo8e59/9f3a0092a4926c4c35e23e764ec2e50b4712dfce">{{ url('/') }}</a>,
                                        ...
                                        log onto your profile, please email {{ config('app.email') }} <br/>
                                        <br/>
                                        Kind Regards,<br/>
                                        The {{ config('app.name') }}.</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="height15 space-class" height="20"> </td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td bgcolor="#8cc03c" class="content red_bg" style="background: #8cc03c" width="800">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                <tr>
                ...
                <tr>
                    <td bgcolor="#8cc03c" class="dark_red_bg space_class" colspan="3" height="2"
                        style="font-size: 1px; line-height: 1px; background: #8cc03c"> 
                    </td>
                </tr>
                </tbody>
            </table>
