            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">
                            We regret to inform you that your debit order details supplied for your account are invalid.
                        </p>
                        <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">
                        ...
                        <ul style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">
                            <li style="font-size: 14px; font-family: Arial, Helvetica, sans-serif"><a href="{{ url('/') }}/auth/login">Login to your account</a></li>
                        ...
                        <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">
                            If you need any assistance to update your debit order details, please feel free to contact us on 012 943 7002 or send an email to {{ config('app.email') }}
                        </p>
                    </td>
                </tr>
                <tr align="center">
