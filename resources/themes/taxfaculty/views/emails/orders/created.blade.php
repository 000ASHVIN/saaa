            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br><br>
                        If you have any questions, please call us on 012 943 7002 or email <a
                                href="mailto:system@taxfaculty.ac.za">system@taxfaculty.ac.za</a>.
                            ...
                            <tr>
                                ...
                                <td>
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0"
                                           class="main_color" bgcolor="#8cc03c"
...
<table class="container590" border="0" height="75" width="600" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td align="center"
            ...
            <p>
                © {{ \Carbon\Carbon::today()->year }} {{ config('app.name') }}. All Rights Reserved.
            </p>
        </td>
    </tr>
