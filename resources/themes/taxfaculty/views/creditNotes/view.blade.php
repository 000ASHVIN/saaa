...
<table class="table" style="width: 90%">
    ...
    <tr>
        <td width="85"></td>
        <td style="padding-top: 20px;"><img src="{{ \URL::to('/') . "/assets/themes/taxfaculty/img/logo.png" }}" alt=""></td>
        <td width="180"></td>
...
<table style="width: 90%">
    ...
    <tr>
        <td style="width: 95px"></td>
        <td style="width: 400px; font-family: Helvetica, Arial; font-size: 14px;"><br> {{ config('app.name') }}</td>
        <td style="width: 20px"></td>
