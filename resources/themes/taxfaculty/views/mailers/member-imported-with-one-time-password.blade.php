            ...
            <table class="container590" border="0"  width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"  style="color: #666666; font-size: 12px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400; line-height: 20px;">
                    ...
                    <td >
                        ...
                        In order to provide you with the best service possible, we have created a profile for you on the {{ config('app.name') }} website.
                        ...
                        If you have any questions about the CPD subscription service, email {{ env('APP_TO_EMAIL') }}.
