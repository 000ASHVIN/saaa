    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::select('province', array_merge(['' => 'Please select....'],App\Province::provincesByCode), null, ['class' => 'form-control','onChange'=>'updateBox(this)']) !!}

                {!! Form::input('text', 'other_province', null, ['class' => 'form-control hidden']) !!}
