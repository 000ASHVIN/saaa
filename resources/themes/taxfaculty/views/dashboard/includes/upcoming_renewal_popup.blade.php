        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    ?>
                    <a href="{{ $popup_link }}" id="btn_renew_subscription" class="btn btn-success" style="background-color: #8cc03c!important; border-color: #8cc03c; margin-top:10px;">Renew Subscription</a>
                </div>
            </div>
        </div>
    </div>
