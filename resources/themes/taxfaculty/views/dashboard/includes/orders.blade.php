            ...
            <tr>
                ...
                <td class="text-center">
                    @if($order->shippingInformation)
                        <button type="button" style="background-color: #173175 !important; border-color: #173175 !important;" class="btn btn-info btn-xs" data-container="body" data-toggle="popover" data-placement="top" data-content="{{ $order->shippingInformation->status->description }}">
