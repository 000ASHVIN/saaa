    ...
    @if(count($recordings) > 0)
        @foreach($recordings->chunk(3) as $chunk)
            ...
            @foreach($chunk as $recording)
                    <div class="col-md-4">
                        <input type="hidden" id="video_id" value="{{ $recording->video->id }}">
                        <div class="border-box" style="margin-bottom: 15px; padding: 0px; min-height: 240px; border-color: #ffffff; -webkit-box-shadow: 0px 6px 16px -5px rgba(0,0,0,0.75); -moz-box-shadow: 0px 6px 16px -5px rgba(0,0,0,0.75); box-shadow: 0px 6px 16px -5px rgba(0,0,0,0.75);">
                            <a style="width: 110%!important;" class="lightbox wod_video_play" href="{!! $recording->video->view_link !!}" data-plugin-options="{&quot;type&quot;:&quot;iframe&quot;}">
                            ...
                            <div class="padding" style="padding: 15px">
                               ...
                               <div class="text-center">
                                    @if($recording->video->view_link)<a href="{!! $recording->video->view_link !!}" data-plugin-options="{&quot;type&quot;:&quot;iframe&quot;}" class="lightbox wod_video_play"> <i class="fa fa-play"></i> Play </a>@endif
                               </div>
                            </div>
                        </div>
                    </div>
                ...
                {{--<div class="col-md-3 text-center">--}}
                    ...
                    {{--<span class="image-hover-icon image-hover-light">--}}
                        {{--<i class="fa fa-play" style="color: #173175"></i>--}}
                    {{--</span>--}}
