<div class="col-lg-3 col-md-3 col-sm-4 hidden-print">
    ...
    <div class="border-box text-center" style="background-color: white">
        ...
        <div class="label label-default planname" style="background-color: #c9c9c8">
        ...
        @else
            @if(! $user->subscribed('cpd'))
                ...
                @if(! $user->hasCompany())
                    <a href="/subscription_plans" class="btn btn-success btn-block" style="background-color: #8cc03c!important; border-color: #8cc03c">Signup for Subscription</a>
                @else
            ...
            @elseif($user->subscribed('cpd') && $user->subscription('cpd')->plan->name == 'Free Plan')
                <a href="/subscription_plans" class="btn btn-success btn-block" style="background-color: #8cc03c!important; border-color: #8cc03c">Upgrade Subscription</a>
            @endif
            
            @if($user->canSelfRenew())
                <?php
                    $user = auth()->user();
                ...
                ?>
                <a href="{{ $popup_link }}" class="btn btn-success btn-block" style="background-color: #8cc03c!important; border-color: #8cc03c; margin-top:10px;">Renew Subscription</a>
            @endif
    ...
    <ul class="nav nav-tabs nav-stacked nav-alternate">
        <li class="{{ isActive('dashboard.general') }}"><a href="{!! route('dashboard.general.index') !!}"><i class="fa fa-angle-double-right"></i> My Dashboard</a></li>
        ...
        <li class="{{ isActive('dashboard.webinars_on_demand', true) }}"><a href="{{ route('dashboard.webinars_on_demand.index') }}"><i class="fa fa-angle-double-right"></i> My Webinars on Demand</a></li>
        ...
        <li class="{{ isActive('resource_centre.home', true) }}"><a href="{!! route('resource_centre.home') !!}"><i class="fa fa-angle-double-right"></i> Resource Centre</a> </li>

        <li class="{{ isActive('dashboard.cpd') }}"><a href="{!! route('dashboard.cpd') !!}"><i class="fa fa-angle-double-right"></i> My CPD Logbook</a></li>        
        @if($user->subscribed('cpd') && $user->subscription('cpd')->plan->price != '0')
        
        @endif


        <li class="{{ (isActive(['dashboard.billing.index','dashboard.wallet.index','dashboard.invoices','dashboard.invoices.overdue','dashboard.invoice_orders','dashboard.invoice_orders','dashboard.statement','dashboard.edit'])=='active')?'showbar':'hidebar' }}" style="background: #fbfbfb;">
            <a class=" dropdown-btn"><i class="fa fa-angle-double-right"></i>  My Account
                <i class="fa fa-caret-down"></i>
            </a>
            <ul  class="nav nav-tabs nav-stacked nav-alternate" style="list-style-type:none;    margin-left: 34px !important;display:none">
                ...
                <li class="{{ isActive(['dashboard.invoices','dashboard.invoices.overdue']) }}"><a href="{!! route('dashboard.invoices') !!}"><i class="fa fa-angle-double-right"></i> My Invoices</a></li>
                <li class="{{ isActive(['dashboard.invoice_orders','dashboard.invoice_orders']) }}"><a href="{!! route('dashboard.invoice_orders') !!}"><i class="fa fa-angle-double-right"></i> My Orders</a></li>
                ...
                <li class="{{ isActive('dashboard.edit', true) }}"><a href="{!! route('dashboard.edit') !!}"><i class="fa fa-angle-double-right"></i> Edit Profile</a></li>
            </ul>
        </li>
        
        <li class="{{ isActive(['dashboard.articles']) }}"><a href="{!! route('dashboard.articles') !!}"><i class="fa fa-angle-double-right"></i> My Articles</a></li>
        <li class="{{ isActive('dashboard.support_tickets', true) }}"><a href="{!! route('dashboard.support_tickets') !!}"><i class="fa fa-angle-double-right"></i> Tickets</a></li>

        @if($user->subscribed('cpd') && $user->subscription('cpd')->plan->price != '0')
        <li class="{{ isActive('faq', true) }}"><a href="{!! route('faq') !!}"><i class="fa fa-angle-double-right"></i> FAQ</a></li>
        @endif
       
        <li class=""><a href="{{ '/auth/logout' }}"><i class="fa fa-angle-double-right"></i> Log Out</a></li>
