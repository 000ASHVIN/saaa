<div class="panel-body" style="max-height: 220px; overflow-y: scroll;">
    <div class="col-md-12">
        ...
        <p>
            ...
            {{ config('app.name') }} or any of its representatives and marketed as such ('the
            Event').
        </p>
        ...
        <p>
            ...
            <br>
            2.2.	“Profile” means Internet Identity with {{ config('app.name') }}. <br>
            2.3.	{{ config('app.name') }}, a private company with registration number 2007/020344/07 and principal place of business at Broadacres Business Centre, hereinafter referred to as “{{ config('app.name') }}”; <br>
        ...
        <p>
            ...
            3.4.	If a client has booked an event but does not receive a confirmation 7 (seven) working days prior to the Event date, it is the responsibility of the client to contact {{ config('app.name') }} at {{ config('app.email') }} and follow-up on the booking. <br>
            3.5.	Registration closes 24 (twenty-four) hours prior to each event. Late registrations shall only be permitted if the client has made prior arrangements with {{ config('app.email') }}. <br>
            3.6.	Venues, times, topics, presenters, programme offerings, and online schedules are subject to change without notice and are determined solely at the discretion of {{ config('app.name') }}. <br>
        </p>
        <p><b>4.	PAYMENT</b></p>
        <p>
            ...
            4.5.2.	Proof of payment should be emailed to {{ config('app.email') }} <br>
