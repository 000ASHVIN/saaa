...
@section('meta_tags')
    <title>{{ $post->checkMetaTitle() }}</title>
    <meta name="description" content="{{ ($post->meta_description!="")?$post->meta_description:(str_limit(strip_tags($post->description), 100)) }}">
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <ul class="blog-post-info list-inline">
                    <li>
                        ...
                        <span class="font-lato">{{ date_format(\Carbon\Carbon::parse($post->publish_date?$post->publish_date:$post->created_at), 'F d, Y') }}</span>
                    </li>
                    <li>
