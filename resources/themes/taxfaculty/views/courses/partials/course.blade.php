        ...
        <div class="padding" style="padding: 15px; text-align: center">
            ...
            <div style="{{ $course->brochure?'':'visibility:hidden;' }}">
                ...
                <div class="form-group form-inline">
                    <button type="button" data-cid="{{$course->id}}"  data-target="#course_brochure_popup" class="btn btn-primary download_brochure form-control">DOWNLOAD COURSE BROCHURE</button>
                </div>
            </div>
