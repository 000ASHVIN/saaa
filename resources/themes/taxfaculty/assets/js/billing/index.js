Vue.component('app-my-billing-screen', {
    ...
    methods: {
        ...
        */
        bankNameChanged() {
            var bank_code = this.forms.debit_order.debit.bank_temp;
            var bank_name = bank_code!=''?this.bank_codes[bank_code]:'';
            this.forms.debit_order.debit.branch_code = this.forms.debit_order.debit.bank_temp;
            this.forms.debit_order.debit.bank = bank_name;
        },
        ...
        UpdateDebitOrderDetails() {
            ...
            if (this.user.cell == "" || this.user.cell == null) {
                swal({
                  type: "error",
                  title: "Error!",
                  text: "There is no cellphone number on your profile in order to send the OTP. Please update your profile first",
                });
                $("#Debit_order_button").modal("hide");
                this.forms.debit_order.busy = false;
                return;
            }
