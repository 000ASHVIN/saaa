Vue.component('installments-stats', {
    ...
    computed: {
        ...
        rows: function () {
            var vm = this;
            var rows = [];
            _.forEach(vm.installments, function (installment, installmentKey) {
                var row = {'columns': []};
                _.forEach(vm.columnConfigs, function (columnConfig, columnKey) {
                    var data = vm.getNestedProperty(installment, columnConfig.dataPath, columnConfig.default);
                    row.columns.push({
                        'id': columnConfig.id,
                        'title': columnConfig.title,
                        'data': data,
