...
<table class="certificate" width="100%">
    <tr style="height: 140px;">
        <td class="certificate-logo">
            @if($pdf)
                <img src="{{ public_path('assets/frontend/certificates/cpd/images/logo.png') }}" width="100%" alt="SA Accounting Academy">
            @else
                <img src="/assets/frontend/certificates/cpd/images/logo.png" alt="SA Accounting Academy" width="100%">
            @endif
        </td>
    </tr>
    <tr>
