...
<div class="container-fluid global-overlay">
    ...
    <div class="side-overlay">
        <div class="left-part">
            <div class="content">
                <h1 class="count">
                    <div class="counter" data-count="504">0</div>
                    <span style="font-size: 60px">Gateway Timeout</span>
                </h1>
                <h2>It's looking like you may have taken a wrong turn.<br> Don't worry... It happens to the best of us.</h2>
                <br>
                <div>
