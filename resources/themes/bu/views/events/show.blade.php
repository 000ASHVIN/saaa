        ...
        <div class="container g-z-index-1 g-py-100 event-inner-banner" style="background-color: rgba(255, 255, 255, 0.8784313725490196)!important;">
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-2">
                    ...
                    <p style="font-size: 16px"><strong>CPD hours: </strong> {{ \Carbon\Carbon::parse($event->start_time)->diffInRealMinutes(\Carbon\Carbon::parse($event->end_time)) / 60 }}  Hours</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="custom-md-4" style="padding: 15px">
                        ...
                        @foreach((count($event->venues) > 1 ? $event->venues->chunk(2) : $event->venues->chunk(1)) as $chunk)
                            <div class="row">
