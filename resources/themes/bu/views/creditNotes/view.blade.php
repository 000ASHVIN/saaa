...
<table class="table" style="width: 90%">
    ...
    <tr>
        <td width="85"></td>
        <td style="padding-top: 20px;"><img src="{{ \URL::to('/') . "/assets/frontend/images/bu_logo.png" }}" alt=""></td>
        <td width="180"></td>
...
<table style="width: 90%">
    ...
    <tr>
        ...
        <td style="font-family: Helvetica, Arial ;text-align: center; font-size: 14px; font-weight: 600; color: #800000; font-size: 14px">QUANTITY</td>
