            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        ...
                        <br>
                        <br>
                        Your initial temporary password is <strong>{{ $user['temp_password'] }}</strong>
                        <br>
                        <br>
                        You are now able to attend free webinars that are included in your company CPD package.
                        <br>
                        <br>
                        To change your password for your new account, Please follow the steps below:
                        <br>
                        <ul>
                            <li>Click on Edit Profile</li>
                            <li>Click on the Password Tab</li>
                            <li>Enter your temporary password underneath "Current Password"</li>
                            <li>Choose a password for your new account</li>
