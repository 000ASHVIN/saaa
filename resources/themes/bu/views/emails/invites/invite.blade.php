        ...
        <td border="0" align="center">
            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Company Invitation Received</td>
                ...
                <tr align="left"
                    ...
                    <td>
                        Dear {{ $invite['first_name'].' '.$invite['last_name'] }}
                        <br><br>
                        You have received an invite to join {{$invite->company->title }}.
                        <br>
                        <br>
                        When confirming this invite, you will have access to free webinars as your company has registered for one of our CPD packages.
                        <br>
                        <br>
                        Should you believe that this email was in error, kindly ignore this email or contact your company administrator.
                        <br>
                        <br>
                        If you have any questions, please call us on 010 593 0466 or email <a href="mailto:admin@accountingacademy.co.za?subject=Company Invitations">admin@accountingacademy.co.za</a>.
