                ...
                <tr align="left"
                    ...
                    <td>
                        <p>
                            ...
                            Kindly take note that your membership verification has been declined by {{
                            $user->body->title }}.
                            <br>
                            <br>
                            ...
                            <br>
                            <br>
                            In order for you to qualify for special prices & discounts on our system we will need you to
                            resend the verification email from your profile by following these easy steps:
                            <br>
                        <ul>
                            <li>Login to your profile.</li>
                            <li>Next to {{ $user->body->title }} click on the small cross.</li>
                        </ul>
                        Your Professional body will now receive another email to confirm your membership. <br><br>
                        You can also contact your Professional body on {{ $user->body->contact_number }} should you have any additional queries regarding your membership.
                        </p>
                    </td>
                </tr>
                <tr align="center">
