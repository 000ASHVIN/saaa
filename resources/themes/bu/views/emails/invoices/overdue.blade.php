    ...
    <tr>
        ...
        <td align="center" border="0">
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" height="35" width="514">
                <tbody>
                <tr>
                    <td align="center"><span class="sg-image" data-imagelibrary="%7B%22width%22%3A0%2C%22height%22%3A0%2C%22alt_text%22%3A%22%22%2C%22alignment%22%3A%22%22%2C%22border%22%3A0%2C%22src%22%3A%22http%3A//imageshack.com/a/img922/5900/TUkbrQ.png%22%2C%22link%22%3A%22%23%22%2C%22classes%22%3A%7B%22sg-image%22%3A1%7D%7D"><a href="#"><img alt="" src="http://imageshack.com/a/img922/5900/TUkbrQ.png" /></a></span></td>
                </tr>
                </tbody>
            </table>
        </td>
        ...
        <td align="center" border="0"><!-- start my table -->
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="container590" width="514"><!-- start space -->
                ...
                <tr align="left" style="color: #666666; font-size: 14px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400; line-height: 20px;">
                    <td>Dear {{ $user->first_name }}<br />
                        <br />
                        Please note that there is an amount outstanding on your account and is immediately payable.
                        <br>
                        <br>
                        Please contact our payments department on <a href="mailto:payments@accountingacademy.co.za">payments@accountingacademy.co.za</a>
                        if you would like us to resend the invoice or if you have any queries.
                        <br>
                        <br>
                        If you have already settled this invoice, please send proof of payment to the same email address in order for us to ensure that the payment is allocated.
                        <br>
                        <br>
                        Below is a list of all invoices outstanding on your account
                        <br>
                        <br>
                        <table class="table" align="center" border="1" cellpadding="1" cellspacing="1" style="width:550px;">
                            <thead>
                            <tr>
                            ...
                            @foreach($user->overdueInvoices() as $invoice)
                                <tr align="center">
                                    <td align="center">#{{ $invoice->reference }}</td>
                                    <td align="center">{{ money_format('%.2n', $invoice->transactions->where('type', 'debit')->sum('amount') - $invoice->transactions->where('type', 'credit')->sum('amount')) }}</td>
                                </tr>
                            @endforeach
                    ...
                    <td>
                        <table border="0">
                            ...
                            <tr>
                                <td width="20">&nbsp;</td>
                                <td>
                                    <table align="center" bgcolor="800000" border="0" cellpadding="0" cellspacing="0" class="main_color" style="border-radius: 5px;" width="200">
                                        <tbody>
                                        <tr>
                                            <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="color: #fff; font-size: 13px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400; line-height: 22px;"><!-- ======= main section button ======= -->
                                                <div style="line-height: 22px;"><a href="https://accountingacademy.co.za/dashboard/invoices" style="color: #fff; text-decoration: none;">View my Invoices</a></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
                        ...
                        <!-- end bouton --><!-- start space --></td>
                </tr>
                <tr>
                    <td height="40">&nbsp;</td>
                </tr>
                <!-- end space --><!-- end my table -->
                </tbody>
            </table>
        </td>
        <td width="18">&nbsp;</td>
...
<table align="center" bgcolor="ffffff" border="0" cellpadding="0" cellspacing="0" class="container590" height="75" width="600">
    ...
    <tr>
        <td align="center" style="color:#c6c6c6; display: block; text-decoration: none; outline: none; border: none;font-size: 14px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400;">&nbsp;
            <p>&copy; 2017 SA Accounting Academy. All Rights Reserved.</p>
        </td>
    </tr>
    </tbody>
</table>
