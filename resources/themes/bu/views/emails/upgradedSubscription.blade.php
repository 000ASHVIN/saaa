...
========
Big Bang Themes Email framework
# Author : Big Bang Themes
# URL : http://themeforest.net/user/bigbangthemes
# Version : 2.0.0
    ...
    <tr>
        <td class="noresponsive">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="800px">
                <tbody>
                <tr>
                    <td border="0" cellpadding="0" cellspacing="0" height="1px; min-width: 800px;"
                            ...
                            <tr>
                                <td align="left" class="col_md_2 mobile_margin_bottom_20" width="370">
                                    <table border="0" cellpadding="0" cellspacing="0" class="mobile_centered_table">
                                        <tbody>
                                        <tr>
                                            <td><a href="#" style="text-decoration: none" target="_blank"><img alt=""
                                                                                                               border="0"
                                                                                                               height="56"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"
                                                            ...
                                                            <a class="dark_grey_text"
                                                               href="https://accountingacademy.co.za/"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"
                                                            ...
                                                            style="color: #35373e; font-family: 'Helvetica'; font-size: 12px; font-weight: 700; line-height: 12px; text-transform: uppercase">
                                                            <a class="dark_grey_text"
                                                               href="https://accountingacademy.co.za/cpd"
                                                               style="color: #35373e; text-decoration: none"
                                                               target="_blank">CPD Subscription  </a></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"
                                                            ...
                                                            style="color: #35373e; font-family: 'Helvetica'; font-size: 12px; font-weight: 700; line-height: 12px; text-transform: uppercase">
                                                            <a class="dark_grey_text"
                                                               href="https://accountingacademy.co.za/store"
                                                               style="color: #35373e; text-decoration: none"
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
       style="height: 435px; width: 800px" width="800">
    <tbody>
    <tr>
        <td><img alt="" src="http://imageshack.com/a/img923/8877/vx3Niw.jpg" style="height: 440px; width: 800px"/></td>
    </tr>
    </tbody>
</table>
                ...
                <tr>
                    ...
                    <td align="center" class="content_row" width="760">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr>
                                <td class="height15" height="30"> </td>
                            </tr>
                            <tr>
                                <td align="center" class="weight_400 lato lighter_grey_text"
                                    style="color: #9e9e9e; font-family: 'Helvetica'; font-size: 14px; font-weight: 400; line-height: 23px">
                                    <span style="font-size: 18pt; color: #000000;"><strong>Dear {{ $user->first_name }} {{ $user->last_name }}</strong></span>
                                </td>
                            </tr>
                            <tr>
                                <td class="height15" height="25"> </td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p>As per our emails from last year advising you that your CPD subscription will
                                        automatically continue into 2017, please be advised that you have been
                                        re-subscribed to our {{ $plan->name }}.<br/>
                                        <br/>
                                        To view your invoice, please click <a
                                                href="https://accountingacademy.co.za/dashboard/invoices"><u>here</u></a>.<br/>
                                        <br/>
                                        Our CPD programme for the year has already started so please ensure prompt
                                        payment of your invoice to ensure that you have access to all our seminars and
                                        webinars.<br/>
                                        <br/>
                                        Please note that we are no longer accepting EFT payments for monthly
                                        subscription packages.  You have the option to pay either via direct debit or by
                                        credit card.<br/>
                                        <br/>
                                        To pay by direct debit, please go onto your profile on <a
                                                href="http://97.107.128.205/index.php/campaigns/rr539nxsle004/track-url/ga346labo8e59/9f3a0092a4926c4c35e23e764ec2e50b4712dfce">www.accountingacademy.co.za</a>,
                                        click on Edit Profile in the left hand column, then click on Account Information
                                        (second tab).  Please complete your account details and also the date you would
                                        like your direct debit to be deducted from your account.<br/>
                                        <br/>
                                        If you would like to pay by credit card, please go onto your profile, click on
                                        My Invoices, click on the Settle button next to any unpaid invoices and your
                                        invoice will appear.  Please complete your credit card details in the boxes
                                        underneath the invoice and click the Settle Invoice button.<br/>
                                        <br/>
                                        If you have any queries regarding your CPD subscription or are not sure how to
                                        log onto your profile, please email <a
                                                href="mailto:admin@accountingacademy.co.za">admin@accountingacademy
                                            .co.za</a> or call 010 593 0466 <br/>
                                        <br/>
                                        Kind Regards,<br/>
                                        The SA Accounting Academy.</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="height15 space-class" height="20"> </td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td class="content height40 space_class" height="10" style="font-size: 1px; line-height: 1px" width="800"> </td>
    </tr>
    </tbody>
</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="wrapper_table"
    ...
    <tbody>
    <tr>
        <td bgcolor="#800000" class="content red_bg" style="background: rgb(23, 49, 117);" width="800">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                <tr>
                    <td class="space_class" colspan="3" height="19" style="font-size: 1px; line-height: 1px"> </td>
                </tr>
                <tr>
                    <td class="padding" width="20"> </td>
                    <td align="center" class="content_row" width="760">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td align="left" class="weight_400 text_center"
                                                ...
                                                Copyright 2017 SA Accounting Academy
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
