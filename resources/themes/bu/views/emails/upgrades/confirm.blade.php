            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="left"
                    ...
                    <td>
                        <p>
                            Greetings, <br><br>
                            We have received an upgrade for {{ $user->first_name }} {{ $user->last_name }}
                            with ID Number {{ $user->id_number }}
                            <br>
                            <br>
                            Member is upgrading from {{ \App\Subscriptions\Models\Plan::find($user->upgrades->last()->old_subscription_package)->name." ".\App\Subscriptions\Models\Plan::find($user->upgrades->last()->old_subscription_package)->interval }}ly to
                            {{ \App\Subscriptions\Models\Plan::find($user->upgrades->last()->new_subscription_package)->name." ".\App\Subscriptions\Models\Plan::find($user->upgrades->last()->new_subscription_package)->interval }}ly
                            <br>
                            <br>
                            <strong>Reason:</strong> {!! $user->upgrades->last()->reason !!}
                        </p>
                    </td>
                </tr>
                <tr align="center">
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="{{ route('upgrade_subscription.approve', $user->id) }}"
                                    ...
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="{{ route('upgrade_subscription.decline', $user->id) }}"
                ...
                <tr align="center"
                    ...
                    <td>
                        <p>
                            Kind regards, <br>
                            The SA Accounting Academy CPD Team
                            <br>
                            <br>
                        </p>
                    </td>
