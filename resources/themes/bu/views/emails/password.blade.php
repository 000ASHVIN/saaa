                ...
                <tr align="left"
                    ...
                    <td>
                        <p style="font-family: Arial, Helvetica,; font-size: 14px">
                            ...
                            You're receiving this email because you requested a password reset for your SA Accounting Academy Account. If
                            you did not request this change, you can safely ignore this email.
                            <br>
                            <br>
                            To choose a new password and complete your request, <a href="{{ url('password/reset/'.$token) }}">please click here.</a>
                            <br><br>
                            You can change your password again at any time from within your dashboard.
                        </p>
                        <ul>
                            <li>Login to your <a href="{{ url('/') }}">Profile</a>.</li>
