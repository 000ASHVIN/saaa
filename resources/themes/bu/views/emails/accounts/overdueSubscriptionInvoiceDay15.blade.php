                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <span style="font-size: 18pt; color: #000000;"><strong>Dear {{ $data->first_name .' '. $data->last_name }}</strong></span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p>Please note that payment for your yearly CPD subscription is now overdue. Please
                                        make payment immediately and forward proof of payment to
                                        <a href="mailto:payments@accountingacademy.co.za">payments@accountingacademy.co.za</a>. <br/>
                                        <br/>
                                        If we do not receive proof of payment in the next 24 hours your account will be
                                        suspended and you will not have access to any of our forthcoming seminars and
                                        webinars.
                                         <br/>
                                        <br/>
                                        To view your invoice, please log onto your profile, click on My Invoices and
                                        click on the blue View button on the right hand side of the relevant
                                        invoice. <br/>
                                        <br/>
                                        If you have any queries regarding your subscription, please contact us on 010 593 0466 or
                                        <a href="mailto:admin@accountingacademy.co.za">admin@accountingacademy.co.za</a>
                                         <br/>
                                        <br/>
                                        <span style="color:#000000;"><span style="font-family:helvetica;"><span
