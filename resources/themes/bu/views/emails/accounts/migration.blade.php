                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="left" class="weight_400 lato lighter_grey_text"
                                    ...
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Dear Accounts</p>
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Please note that the following member was migrated to <strong>Peach Payments</strong> and that they need to be removed from Stratcol immediately.</p>
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">The details of the account is as follows:</p>

                                    <ul>
                                        <li style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Bank: {{ ucfirst($debit->bank) }}</li>
                                        <li style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Name: {{ $debit->user->full_name() }}</li>
                                        <li style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Branch Code: {{ $debit->branch_code }} </li>
                                        <li style="font-size: 14px; font-family: Arial, Helvetica, sans-serif">Account Number: {{ $debit->number }}</li>
                                    </ul>
