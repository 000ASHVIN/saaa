                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="thumbnail relative margin-bottom-3">
                                    <figure data-mode="mouseover" style="position: relative; overflow: hidden;">
                                        ...
                                        @else
                                            <img style="width: 102%" src="/assets/frontend/images/shop/products/default.png" alt="{{ $listing->title }}"/>
                            ...
                            @if(($listing->discount) > 0)
                                <div class="col-sm-12">
                                    <div class="alert alert-info text-center"
                                        style="background-color: #800000;color: white; border-style: dashed; margin-bottom: 10px; margin-top: 10px; padding: 5px;">
