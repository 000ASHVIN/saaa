<div class="panel panel-default" v-if="forms.checkout.paymentOption == 'cc'">
    ...
    <div class="panel-body">
        ...
        <ul class="list-group" v-if="user.cards.length > 0 && ! readyForThreeDs">
            <li class="list-group-item" v-for="card in user.cards">
            	<label>
            		<input type="radio" name="card" v-model="forms.checkout.card" :value="card.id" :checked="card.id == user.primary_card">
            		@{{ card.number }}
            	</label>
            	<span>
        ...
        <div v-if="(! forms.checkout.card || addingNewCard) && ! readyForThreeDs">
        	<hr>
...
<div class="row"  v-if="forms.checkout.paymentOption == 'cc'">
	<div class="col-md-12">
		<div class="form-group">
            <button type="submit" class="btn btn-primary btn-block" @click.prevent="checkout" :disabled="forms.checkout.busy" v-if="user.cards.length > 0">
