    ...
    <tr>
        ...
        <td style="width: 400px; font-family: Helvetica, Arial; font-size: 14px; color: #656464; vertical-align: text-top;">
            <table>
                ...
                <span style="line-height: 1.7em; font-family: Helvetica, Arial;">
                    {{ ($order->user->profile->tax) ? 'Vat Number:' . $order->user->profile->tax : $order->user->email }}
                </span>
            </table>
        </td>
    </tr>
...
<table style="width: 90%">
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 10px; font-family: Helvetica, Arial; font-size: 12px" bgcolor="#eaeaea">R {{ number_format($order->total - (($order->total / ($order->vat_rate + 100)) * 100), 2) }}</td>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 10px; font-family: Helvetica, Arial; font-size: 12px; color: white" bgcolor="#800000">R {{ number_format($order->balance, 2) }}</td>
    </tr>
    ...
    <tr>
        <td style="width: 95px"></td>
        <td style="width: 400px; font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #800000; padding-bottom: 10px;">BANKING DETAILS</td>
        <td style="width: 20px"></td>
        <td style="width: 400px; font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #800000; padding-bottom: 10px;"></td>
    </tr>

    <tr>
        <td style="width: 95px"></td>
        <td colspan="4" style="font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #800000; padding-bottom: 10px; border-bottom: 2px solid; border-color: #800000"></td>
    </tr>
...
<table width="90%">
    ...
    <tr>
        ...
        <td style="width: 400px; font-family: Helvetica, Arial; font-size: 14px; font-weight: 600; color: #800000; padding-bottom: 10px;">SNAPSCAN</td>
    </tr>
