@if(count($tickets))
    ...
    @if(isset($year))
        ...
        <table class="table table-hover">
            ...
            @foreach($tickets->sortByDesc('id')->slice($limit, $howMany) as $ticket)
                <tr>
                    <td class="text-left">
                    ...
                    <td valign="top" class="text-left">
                        <i class="fa fa-clock-o"></i> {{ $ticket->event->start_time }} <br>
                    </td>
    ...
    @else
        <div class="row">
            @foreach($tickets->groupBy('event_year') as $key => $value)
