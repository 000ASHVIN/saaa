<div class="panel panel-default" v-if="forms.pay.paymentOption == 'cc'">
    ...
    <div class="panel-body">
        ...
        <ul class="list-group" v-if="user.cards.length > 0 && ! readyForThreeDs">
            <li class="list-group-item" v-for="card in user.cards">
            	<label>
            		<input type="radio" name="card" v-model="forms.pay.card" :value="card.id" :checked="card.id == user.primary_card">
            		@{{ card.number }}
            	</label>
            	<span>
        ...
        <div v-if="(! forms.pay.card || addingNewCard) && ! readyForThreeDs">
        	<hr>
