        ...
        <td border="0" align="center">
            ...
            <table class="container590" border="0" width="514" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr align="center"
                    ...
                    <td>Debit Order Form Required</td>
                ...
                <tr align="left"
                    style="color: #666666; font-size: 12px; font-family: 'Open Sans', Calibri, sans-serif; font-weight: 400; line-height: 20px;">

                    <td>
                        Dear {{ $first_name }}, <br/><br/>

                        You indicated that you would prefer to pay your CPD Subscription via debit order, as such kindly
                        fill out the required debit order form by selecting your preferred language below. Alternatively
                        you can also settle your invoices on your profile via Credit Card.

                        <br/><br/>
                        For further details on the CPD subscription service, please refer to our <a
                                href="{{ route('terms_and_conditions') }}">Terms and Conditions</a>.

                        <br/><br/>

                        If you have any questions about the CPD subscription service, then please call us on 010 593
                        0466 or email <a href="mailto:admin@accountingacademy.co.za">admin@accountingacademy.co.za</a>.

                        <br><br><br>

                        <center>
                            <h2>Download Debit Order Form</h2>
                        </center>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="https://www.dropbox.com/s/vrgpar7kycizj79/7923%20-%20Final%20New%20Mandate%20-%20Afrikaans.pdf?dl=1"
                                                       style="color: #fff; text-decoration: none;">Afrikaans</a>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" align="center" width="200" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="https://www.dropbox.com/s/pgmcnllhncyhdpl/7923_Final%20New%20Mandate%20-%20English%281%29.pdf?dl=1"
                                                       style="color: #fff; text-decoration: none;">English</a>
                                                </div>
                                            </td>
                                        </tr>
