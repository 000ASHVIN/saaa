...
<section style="background-image: url('/assets/frontend/images/demo/wall2.jpg'); padding-bottom: 10px; padding-top: 30px">
    ...
    <div class="container text-center">
        <h4><span>SA Accounting Academy is a SAIBA Approved CPD Provider </span></h4>
        <br>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="text-align: left">
                    ...
                    <a href="https://accountingacademy.co.za/draftworx" class="btn btn-primary pull-right"><i class="fa fa-arrow-right"></i> Find out more</a>
                </div>
            </div>
            ...
            <div class="row" style="background-color: #e3e3e357; padding-top: 15px; padding-bottom: 15px; margin-top: 15px; margin-bottom: 15px">
                ...
                <div class="col-md-10" style="text-align: left">
                    ...
                    <a href="https://accountingacademy.co.za/bluestar" class="btn btn-primary pull-right"><i class="fa fa-arrow-right"></i> Find out more</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="text-align: left">
                    ...
                    <a href="https://accountingacademy.co.za/quickbooks" class="btn btn-primary pull-right"><i class="fa fa-arrow-right"></i> Find out more</a>
                </div>
            </div>
            ...
            <div class="row" style="background-color: #e3e3e357; padding-top: 15px; padding-bottom: 15px; margin-top: 15px; margin-bottom: 15px">
                ...
                <div class="col-md-10" style="text-align: left">
                    ...
                    <a href="https://accountingacademy.co.za/saiba" class="btn btn-primary pull-right"><i class="fa fa-arrow-right"></i> Find out more</a>
                </div>
            </div>
        </div>
    </div>
