<div class="div" v-if="selectedPlan.is_custom">
    <div class="alert alert-info">
        <p>
            The ESSENTIAL PLUS programme for Build your own is a webinar only package. Please choose only 8 of the
    ...
    <div class="callout callout-theme-color">
        <div class="row">
            <div class="col-md-9">
                ...
                <p>Please select your topics, you have selected <strong>(@{{ countSelectedFeatures }}/8)</strong></p>
            </div>
