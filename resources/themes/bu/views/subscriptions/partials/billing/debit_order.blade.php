    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" role="form">
            <div class="form-group" :class="{'has-error': forms.subscription.errors.has('bank')}">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="bank" data-stripe="bank" v-model="forms.subscription.debit.bank">
            ...
            <div class="form-group" :class="{'has-error': forms.subscription.errors.has('branch_name')}">
            ...
            <div class="form-group" :class="{'has-error': forms.subscription.errors.has('branch_code')}">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="branch_code" data-stripe="branch_code" v-model="forms.subscription.debit.branch_code">
