        ...
        <div class="container">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="heading-title heading-dotted text-center">
                    <h2 style="background-color: #800000; color: white">Subscription Packages</h2>
        ...
        <div class="container">
            ...
            @foreach($professions as $profession)
                <div v-if="profession == '{!! $profession->title !!}'">
                    <div class="row">
                        <app-subscriptions-screen :plans="{{ $profession->plans }}" :profession="{{ $profession }}" :user="{{ auth()->user() }}" inline-template>
