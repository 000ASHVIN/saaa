...
<!--
    ...
    <img src="/assets/frontend/images/demo/1200x800/banner.jpg" alt="Slide 2" style="width: 100%">
    {{--<div class="text-center" style="position: absolute; bottom: 113px; width: 100%; background-color: #8000007a;">--}}
    {{--<br>--}}
...
<div class="callout-dark heading-arrow-top">
    <a href="/auth/register" class="btn btn-xlg btn-primary size-10 fullwidth nomargin bopadding noradius ">
        <span class="font-lato size-30">
            <span style="font-size: 20px">Resource Centre | Access to experts | Live & On Demand Webinars | Acts Online</span></span>
    </a>
</div>
...
<div class="text-center alternate">
    <a class="btn btn-primary btn-lg" href="/cpd"><i class="fa fa-search"></i> View Options</a>
</div>
