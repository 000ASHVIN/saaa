<div id="discount" class="tab-pane fade">
    @if(count($course->promoCodes))
        <table class="table table-bordered table-striped">
            ...
            <tbody>
            @foreach($course->promoCodes as $code)
                <tr>
                    ...
                    <td class="text-center"><a data-confirm-content="Are you sure you want to delete the selected code" class="label label-info" href="{{ route('admin.course.discount.destroy', $code
                    ->code) }}">X</a></td>
                </tr>

                @include('admin.courses.includes.discount.edit')
            @endforeach
            </tbody>
        </table>
    @else
        <div class="alert alert-info">
            <p>There is no discount codes for this course.</p>
        </div>
    @endif
        ...
        <div class="form-group">
            ...
            @include('admin.courses.includes.discount.create')
        </div>
</div>