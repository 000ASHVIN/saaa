...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <members-stats :members="{{ $members->toJson() }}" inline-template>
                <br>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#date-range').on('apply.daterangepicker', function (event, picker) {
                var newUrl = '/admin/stats/members?start-date=' + picker.startDate.format('YYYY-MM-DD') + '&end-date=' + picker.endDate.format('YYYY-MM-DD');
