...
@section('title', 'Stats')
@section('description', 'Subscriptions Installments')
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="date-range">
                Due Date range: <input id="date-range" type="text">
            </label>
            <installments-stats :installments="{{ $installments->toJson() }}" inline-template>
                <br>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#date-range').on('apply.daterangepicker', function (event, picker) {
                var newUrl = '/admin/stats/installments?start-date=' + picker.startDate.format('YYYY-MM-DD') + '&end-date=' + picker.endDate.format('YYYY-MM-DD');
