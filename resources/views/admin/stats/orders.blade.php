...
@section('title', 'Stats')
@section('description', 'Store Orders')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <orders-stats :orders="{{ $orders->toJson() }}" inline-template>
                <br>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#date-range').on('apply.daterangepicker', function (event, picker) {
                var newUrl = '/admin/stats/orders?start-date=' + picker.startDate.format('YYYY-MM-DD') + '&end-date=' + picker.endDate.format('YYYY-MM-DD');
