<div id="pricings" class="tab-pane fade in">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                @foreach($event->pricings as $pricing)
                    ...
                    @include('admin.synced_events.includes.bodies.update')
                    @include('admin.synced_events.includes.pricings.update')
                    @include('admin.synced_events.includes.pricings.delete')
                    @include('admin.synced_events.includes.feature.update')
                @endforeach
            </tbody>
        </table>
    @else
    ...
    {{-- <div class="form-group">
        ...
        @include('admin.synced_events.includes.pricings.create')
    </div> --}}
</div>