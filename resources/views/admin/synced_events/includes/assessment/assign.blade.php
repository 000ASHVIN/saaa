    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['method' => 'post', 'route' => ['admin.event.assessment.store', $event->slug]]) !!}

                <div class="form-group @if ($errors->has('assessments[]')) has-error @endif">
                    {!! Form::label('assessments[]', 'Please select your features') !!}
                    {!! Form::select('assessments[]', $assessments->pluck('title', 'id')->toArray(), $event->assessments->pluck('id')->toArray(), ['class' => 'select2', 'multiple' => true, 'style' => 'width:100%']) !!}
