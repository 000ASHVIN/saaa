...
@section('content')
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        @include('admin.reports.invoices.p-period.includes.form')
    </div>
    ...
    <div class="container-fluid container-fullw padding-bottom-10">
        <div class="col-md-2">
            <div class="panel panel-white no-radius text-center">
                <div class="panel-body">
                    ...
                    <h4 style="margin-top: 10px" class="StepTitle">Invoices</h4>
                    <p class="text-small">
                        R{{ number_format($totalInvoices->sum('amount'), 2) }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="panel panel-white no-radius text-center">
                <div class="panel-body">
                    ...
                    <p class="text-small">
                        R{{ number_format($cancellations->sum('amount'), 2) }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="panel panel-white no-radius text-center">
                <div class="panel-body">
                    <span class="fa-stack fa-2x"> <i class="fa fa-file fa-stack-2x text-primary"></i> <i class="fa fa-money fa-stack-1x fa-inverse"></i> </span>
                    <h4 style="margin-top: 10px" class="StepTitle">Credits</h4>
                    <p class="text-small">
                        R{{ number_format($credits->sum('amount'), 2) }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="panel panel-white no-radius text-center">
                <div class="panel-body">
                    ...
                    <p class="text-small">
                        R{{ number_format($totalInvoices->sum('amount') - $credits->sum('amount'), 2) }}
                    </p>
                </div>
            </div>
        </div>
