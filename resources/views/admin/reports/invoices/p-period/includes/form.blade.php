@if(isset($from))
    {!! Form::open(['method' => 'post', 'route' => ['admin.reports.payments.export_results_outstanding_p_p', isset($from), isset($to)]]) !!}
...
{!! Form::open(['method' => 'post', 'route' => 'admin.reports.payments.results_outstanding_p_p']) !!}
<div class="row">
    <div class="col-md-6">
