...
@section('title', 'Extract Invoices')
...
@section('content')
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            ...
            <ul>
                <li>All Invoices from the selected from date to the selected to date.</li>
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            {!! Form::open(['method' => 'post', 'route' => 'admin.reports.payments.post_extract_invoices']) !!}
            <div class="col-md-6">
