...
@section('title', 'Extract Events Stat')
@section('description', 'Extract a list of events stat for a specific time frame')
...
@section('content')
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            ...
            <ul>
                <li>All Events Stat from the selected from date to the selected to date.</li>
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            {!! Form::open(['method' => 'post', 'route' => 'admin.reports.events.stat.post_extract']) !!}
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                <button type="submit" name="submit" class="btn btn-success">Extract Report</button>
            </div>
