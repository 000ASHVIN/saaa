...
@section('title', 'Extract Purchase Orders')
@section('description', 'Extract a list of purchase orders for a specific time frame')
...
@section('content')
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            ...
            <ul>
                <li>All Purchase orders from the selected from date to the selected to date.</li>
    ...
    <div class="container-fluid container-fullw padding-bottom-10 bg-white">
        <div class="row">
            {!! Form::open(['method' => 'post', 'route' => 'admin.reports.payments.purchase_orders.post_extract']) !!}
            <div class="col-md-6">
