...
class technical_update_event_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            ...
            'end_date' => new Carbon('27-06-2016'),
            'next_date' => new Carbon('27-06-2016'),
            'start_time' => new Carbon('27-06-2016 10:00'),
            'end_time' => new Carbon('27-06-2016 12:00'),
