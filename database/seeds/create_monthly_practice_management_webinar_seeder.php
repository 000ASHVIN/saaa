...
class create_monthly_practice_management_webinar_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            ...
            'slug' => 'monthly-practice-management-webinar',
            ...
            'start_date' => new Carbon('24-08-2016'),
            'end_date' => new Carbon('24-08-2016'),
            'next_date' => new Carbon('24-08-2016'),
            'start_time' => new Carbon('24-08-2016 14:00'),
            'end_time' => new Carbon('24-08-2016 16:00'),
