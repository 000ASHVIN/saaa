...
class create_technical_udpate_webinar_4_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            ...
            'slug' => 'monthly-accounting-technical-update-4',
            ...
            'start_date' => new Carbon('10-11-2016'),
            'end_date' => new Carbon('10-11-2016'),
            'next_date' => new Carbon('10-11-2016'),
            'start_time' => new Carbon('10-11-2016 14:00'),
            'end_time' => new Carbon('10-11-2016 15:00'),
