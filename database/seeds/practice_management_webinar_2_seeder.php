...
class practice_management_webinar_2_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            ...
            'slug' => 'monthly-practice-management-webinar-2',
            ...
            'start_date' => new Carbon('29-09-2016'),
            'end_date' => new Carbon('29-09-2016'),
            'next_date' => new Carbon('29-09-2016'),
            'start_time' => new Carbon('29-09-2016 14:00'),
            'end_time' => new Carbon('29-09-2016 15:00'),
