...
class AccountingForCommonTaxTransactionsSeminarSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $seminar = Event::create([
            'type' => 'seminar',
            'name' => 'Accounting for Common Tax Transactions',
            'slug' => 'accounting-for-common-tax-transactions',
            ...
            'end_date' => new Carbon('22-04-2016'),
            'next_date' => new Carbon('11-04-2016'),
            'start_time' => new Carbon('11-04-2016 09:00'),
            'end_time' => new Carbon('11-04-2016 13:00'),
