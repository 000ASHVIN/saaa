...
class IfrsForSmesUpdateJulySeminarEventSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $seminar = Event::create([
            'type' => 'seminar',
            'name' => 'IFRS for SMEs Update',
            'slug' => 'ifrs-for-smes-update',
            'description' => '<p>Coming soon...</p>',
            'featured_image' => '/assets/frontend/images/events/2016/fake-test-event.jpg',
            'start_date' => new Carbon('19-07-2016'),
            'end_date' => new Carbon('28-07-2016'),
            'next_date' => new Carbon('19-07-2016'),
            'start_time' => new Carbon('19-07-2016 09:00'),
            'end_time' => new Carbon('19-07-2016 13:00'),
            'short_description' => 'The IFRS for SMEs standard is fundamental to company law.  It is the prescribed standard for most companies and an incorrect application may result in liabilities for your clients and your firm.  Join Prof. Hentie van Wyk for this half-day seminar when he will explain the practical application of the latest updates ',
