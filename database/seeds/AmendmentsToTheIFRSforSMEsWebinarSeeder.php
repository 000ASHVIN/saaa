...
class AmendmentsToTheIFRSforSMEsWebinarSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            'type' => 'webinar',
            'name' => 'Amendments to the IFRS for SMEs',
            'slug' => 'amendments-to-the-ifrs-for-smes',
            'description' => '<p>Coming soon...</p>',
            'featured_image' => '/assets/frontend/images/events/2016/amendments-to-the-ifrs-for-smes.jpg',
            'start_date' => new Carbon('09-03-2016'),
            'end_date' => new Carbon('09-03-2016'),
            'next_date' => new Carbon('09-03-2016'),
            'start_time' => new Carbon('09-03-2016 14:00'),
            'end_time' => new Carbon('09-03-2016 16:00'),
