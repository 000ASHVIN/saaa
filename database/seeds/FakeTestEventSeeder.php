...
class FakeTestEventSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $seminar = Event::create([
            ...
            'slug' => 'fake-test-event',
            'description' => '<p>Coming soon...</p>',
            'featured_image' => '/assets/frontend/images/events/2016/fake-test-event.jpg',
            'start_date' => new Carbon('10-12-2106'),
            'end_date' => new Carbon('20-12-2016'),
            'next_date' => new Carbon('10-12-2106'),
            'start_time' => new Carbon('10-12-2106 09:00'),
            'end_time' => new Carbon('10-12-2106 13:00'),
