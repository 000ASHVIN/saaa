...
class monthly_technical_update_2 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $webinar = Event::create([
            'type' => 'webinar',
            'name' => 'Monthly accounting technical update 2',
            'slug' => 'monthly-accounting-technical-update-2',
            ...
            'start_date' => new Carbon('08-09-2016'),
            'end_date' => new Carbon('08-09-2016'),
            'next_date' => new Carbon('08-09-2016'),
            'start_time' => new Carbon('08-09-2016 10:00'),
            'end_time' => new Carbon('08-09-2016 12:00'),
