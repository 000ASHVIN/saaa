...
class SendPdfInvoice
{
    ...
    public function generate(Invoice $toGenerate)
    {
        ...
        $invoice->addParagraph("Bank: ABSA Bank <br>Account Holder: SA Accounting Academy<br>Account Number: 4077695135<br>Branch Code: 632005");
        ...
        $invoice->setFooternote("Vat Number: 4850255789");

        $path = public_path('assets/frontend/invoices/invoice-'.$toGenerate->reference.'.pdf');
        $invoice->render($path);
    }
}