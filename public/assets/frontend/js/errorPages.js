...
!function (t) {
    ...
    i.DEFAULTS = {
        ...
        return this.each(function () {
            var s = $(this), e = s.data("countTo"), n = !e || "object" == typeof t, o = "object" == typeof t ? t : {},
    ...
    $("#contact-form [type='submit']").click(function (t) {
        t.preventDefault();
        var i = $("input[name=email-address]").val(), s = $("textarea[name=message]").val();
        post_data = {userEmail: i, userMessage: s}, $.post("php/contact-me.php", post_data, function (t) {
    ...
    $(".right-part").vegas({
        slides: [{src: "http://cdn.themehelite.com/themeforest/404rpz/img/slide-1.jpg"}, {src: "http://cdn.themehelite.com/themeforest/404rpz/img/slide-2.jpg"}],
        delay: 5e3,
        transition: "fade",
        animation: "kenburns"
    })
    ...
    s.prototype = {
        _init: function () {
            var t, i, s, e = "BODY" === this.elmt.tagName, n = this.settings.timer, o = this.settings.overlay, a = this;
            ...
            var s = this, e = i / 10, n = t.volume - .09;
            ...
            var s, e, n, o = this.$elmt.children(".vegas-slide"), a = this.settings.slides[t].src,
                r = this.settings.slides[t].video, l = this._options("delay"), d = this._options("align"),
                h = this._options("valign"), c = this._options("color") || this.$elmt.css("background-color"),
                u = this._options("cover") ? "cover" : "contain", p = this, m = o.length, g, f,
                v = this._options("transition"), y = this._options("transitionDuration"),
                _ = this._options("animation"), w = this._options("animationDuration");
            ...
            if ("object" == typeof i) this.settings = $.extend({}, t, $.vegas.defaults, i); else {
    ...
    var a = {hasClass: e, addClass: n, removeClass: o, toggleClass: s, has: e, add: n, remove: o, toggle: s};
    ...
    var e = {animations: Modernizr.cssanimations}, n = {
        WebkitAnimation: "webkitAnimationEnd",
        OAnimation: "oAnimationEnd",
        msAnimation: "MSAnimationEnd",
        animation: "animationend"
    }, o = n[Modernizr.prefixed("animation")], a = function (t, i) {
        var s = function (t) {
            if (e.animations) {
