...
var Profile = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "/assets/admin/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "/assets/admin/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "https://saiba.org.za/assets/images/logo-light@2x.png");
					break;
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "/assets/admin/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "/assets/admin/assets/images/logo.png");
